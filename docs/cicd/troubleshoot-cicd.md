...
:::image type="content" border="true" source="./media/troubleshoot-cicd/rules-grayed-out-1.png" alt-text="A screenshot showing deployment pipelines deployment rules grayed out.":::
