...
:::image type="content" source="media/media/troubleshoot-cicd/out-1.png" alt-text="A screenshot showing deployment pipelines deployment rules grayed out." lightbox="media/media/troubleshoot-cicd/out-1.png":::
