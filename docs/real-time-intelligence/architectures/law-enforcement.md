...
:::image type="content" source="./media/law-enforcement/law-enforcement-reference-architecture.png" alt-text="Diagram showing the reference architecture for law enforcement operations." lightbox="./media/law-enforcement/law-enforcement-reference-architecture.png":::
