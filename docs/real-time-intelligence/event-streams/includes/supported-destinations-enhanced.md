...
| [Spark Notebook (Preview)](../add-spark-notebook-destination.md) | Add a **Spark Notebook** destination to load a pre-existing Notebook in your workspace to process the events in the default or derived streams using a Spark Structured Streaming job. This feature is currently in **Preview**. |
