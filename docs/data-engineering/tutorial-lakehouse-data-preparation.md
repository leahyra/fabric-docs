...
1. Choose one notebook based on your preferred language:

   - **Prepare and transform data - PySpark** (`03 - Tutorial PySpark.ipynb`)
   - **Prepare and transform data - Spark SQL** (`03 - Tutorial Spark SQL.ipynb`)
...
1. Select only the notebook that matches your selected language.
...
1. Select your imported notebook (**Prepare and transform data - PySpark** or **Prepare and transform data - Spark SQL**) and select **Open**. The notebook is already linked to your opened lakehouse, as shown in the lakehouse **Explorer**.
...
Select the tab that matches the notebook you imported, and keep using that same tab for all steps.
