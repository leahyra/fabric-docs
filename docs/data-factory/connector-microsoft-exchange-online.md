...
You can connect Dataflow Gen2 to Microsoft Exchange Online in Microsoft Fabric using Power Query connectors. Follow these steps to create your connection:
