...
[!INCLUDE[apache-airflow-note](includes/apache-airflow-note.md)] Currently, private networks and Vnet are not supported with Fabric Apache Airflow jobs. This feature is under development and will be updated soon.
