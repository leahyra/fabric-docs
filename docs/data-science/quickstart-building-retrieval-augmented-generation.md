...
1. Create embeddings by using Fabric's built-in [Azure OpenAI services through Synapse ML](ai-services/how-to-use-openai-synapse-ml).
1. Create a vector index by using [Azure AI Search](https://aka.ms/what-is-azure-search).
1. Generate answers from the retrieved context by using Fabric's built-in [Azure OpenAI through Python SDK](ai-services/how-to-use-openai-python-sdk).
...
> [!NOTE]
> For other available deployment_ids, see the [documentation for Python SDK](ai-services/how-to-use-openai-python-sdk).
